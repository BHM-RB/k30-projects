...
VOCAB_DIR=BASE + '/vocab.json'
TRAINED_MODEL_DIR=BASE + "/trained_model/checkpoint-4000"
PRETRAIN_MODEL_DIR=BASE + '/pretrained_model'

from datasets import load_dataset, load_metric

timit = load_dataset("timit_asr", cache_dir=DATASET_DIR)
...
processor = Wav2Vec2Processor.from_pretrained(TRAINED_MODEL_DIR)

model = Wav2Vec2ForCTC.from_pretrained(TRAINED_MODEL_DIR)
